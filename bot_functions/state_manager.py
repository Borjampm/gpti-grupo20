...
# Individual bulk operation states - each bulk operation now has its own state
AWAITING_ZIP_FOR_PNG_TO_JPEG = "AWAITING_ZIP_FOR_PNG_TO_JPEG"
AWAITING_ZIP_FOR_JPEG_TO_PNG = "AWAITING_ZIP_FOR_JPEG_TO_PNG"
AWAITING_ZIP_FOR_SVG_TO_PNG = "AWAITING_ZIP_FOR_SVG_TO_PNG"
AWAITING_ZIP_FOR_SVG_TO_JPEG = "AWAITING_ZIP_FOR_SVG_TO_JPEG"
